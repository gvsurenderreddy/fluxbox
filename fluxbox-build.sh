...
## Enter the name of the folder that holds your fluxbox dev file
basef=`pwd`
...
[ ! -d $basef/PKG${SUFFIX} ] && { echo "Run this script from root of fluxbox dev folder"; exit; }
...
cd build
./launch_before_go_fluxbox.sh
rm launch_before_go_fluxbox.sh
cd -
dir2xzm build 003-fluxbox${SUFFIX}.xzm